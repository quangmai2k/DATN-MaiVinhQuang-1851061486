...
class _ModalDanhSachTTSTienCuState extends State<ModalDanhSachTTSTienCu> {
  ...
  List<int> listTTSDonHang =
      []; // list id TTS đơn hàng để truyền sang modal_confirm
  List<int> listIdDonHangTtsTienCu =
      []; // list id TTS đơn hàng thực tập sinh tiến cử
                ...
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text('Danh sách thực tập sinh đề xuất tiến cử',
                            style: titleBox),
                      ],
                    ),
                  ],
                    ...
                    ? () {
                        showDialog(
                            ...
                            builder: ((BuildContext context) => ModalDungXuLy(
                                  titleDialog:
                                      'Lý do dừng xử lý', //header bảng trong cùng
                                  ttsId: null,
