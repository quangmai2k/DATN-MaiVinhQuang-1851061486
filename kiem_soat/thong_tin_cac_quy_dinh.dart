...
class ThongTinCacQuyDinh extends StatefulWidget {
  const ThongTinCacQuyDinh({Key? key}) : super(key: key);

  @override
  State<ThongTinCacQuyDinh> createState() => _ThongTinCacQuyDinhState();
}

class _ThongTinCacQuyDinhState extends State<ThongTinCacQuyDinh> {
  @override
  Widget build(BuildContext context) {
    return HeaderAndNavigation(widgetBody: ThongTinCacQuyDinhBody());
  }
}

class ThongTinCacQuyDinhBody extends StatefulWidget {
  const ThongTinCacQuyDinhBody({Key? key}) : super(key: key);

  @override
  State<ThongTinCacQuyDinhBody> createState() => _ThongTinCacQuyDinhBodyState();
}

class _ThongTinCacQuyDinhBodyState extends State<ThongTinCacQuyDinhBody> {
  final String urlAddNewUpdate1 = "/them-moi-ttqd";
  final String urlAddNewUpdate2 = "/cap-nhat-ttqd";
  final String urlTTQDinh = "/chi-tiet-ttqd";
  ...
  Future getQuyDinh(page, String findSearch) async {
    ...
    if (findSearch == "") {
      response = await httpGet(
          "/api/quydinh/get/page?page=$page&size=$rowPerPage&sort=id", context);
    } else {
      response = await httpGet(
          "/api/quydinh/get/page?page=$page&size=$rowPerPage&sort=id&filter=$findSearch",
          context);
    }
                                ...
                                Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      if (_tenQD.text != "")
                                        tenQD =
                                            "and ruleName~'*${_tenQD.text}*' ";
                                      else
                                        tenQD = "";
                                      if (_noiDungVP.text != "")
                                        noiDungVP =
                                            "and ruleName~'*${_noiDungVP.text}*' ";
                                      else
                                        noiDungVP = "";
                                            ...
                                            Container(
                                                ...
                                                child: InkWell(
                                                    onTap: () {
                                                      navigationModel.add(
                                                          pageUrl:
                                                              "/them-moi-ttqd/${resultQuyDinh["content"][i]["id"]}");
                                                    },
                                                    child: Icon(
                                                        Icons.edit_calendar,
                                                        color: Color(
