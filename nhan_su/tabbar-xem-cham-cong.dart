...
import '../../forms/nhan_su/view-cham-cong-ver1.dart';

class TabBarXemChamCong extends StatefulWidget {
  var listNVCC;
  TabBarXemChamCong({this.listNVCC});
  @override
  State<TabBarXemChamCong> createState() => TabBarXemChamCongState();
}

class TabBarXemChamCongState extends State<TabBarXemChamCong> with SingleTickerProviderStateMixin {
          ...
          children: <Widget>[
            ...
            Expanded(
              child: TabBarView(controller: _tabController, children: [
                for (var element in listNVCC.keys) ViewCCVer1(listNVCC[element]),
              ]),
            )
          ],
        ),
