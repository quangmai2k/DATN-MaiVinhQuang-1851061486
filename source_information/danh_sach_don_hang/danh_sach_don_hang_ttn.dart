...
class _DanhSachDonHangTTNBodyState extends State<DanhSachDonHangTTNBody> {
  ...
  Future<dynamic> pageChange(page) async {
    ...
    // print("/api/donhang/get/page?page=$page&size=$rowPerPage&filter=orderStatusId:2 and stopProcessing:0 and nominateStatus:0 $searchRequest");
                                            ...
                                            for (int i = 0; i < listOrder["content"].length; i++)
                                              DataRow(
                                                cells: <DataCell>[
                                                  ...
                                                  DataCell(
                                                    Text(listOrder["content"][i]["orderCode"] ?? "", style: bangDuLieu),
                                                  ),
                                                  DataCell(
                                                    Container(
                                                      ...
                                                      child: Text(listOrder["content"][i]["orderName"], style: bangDuLieu),
                                                    ),
                                                  ),
                                                  DataCell(
                                                    Container(
                                                      width: MediaQuery.of(context).size.width < 1600
                                                          ...
                                                          : MediaQuery.of(context).size.width * 0.15,
                                                      child: Text(listOrder["content"][i]["nghiepdoan"]["orgName"] ?? "", style: bangDuLieu),
                                                    ),
                                                  ),
                                                  DataCell(
                                                    Text(listOrder["content"][i]["nganhnghe"]["jobName"] ?? "", style: bangDuLieu),
                                                  ),
                                                  DataCell(
                                                    Container(
                                                        child: TextButton(
                                                      ...
                                                      children: [
                                                        Center(
                                                          child: Container(
                                                            child: InkWell(
                                                              onTap: () {
                                                                navigationModel.add(pageUrl: "/thong-tin-don-hang/${listOrder["content"][i]['id']}");
