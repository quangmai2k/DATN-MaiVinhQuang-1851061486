...
class DeNghiThuongChiTieu extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return HeaderAndNavigation(
      widgetBody: DeNghiThuongChiTieuBody(),
    );
  }
}

class DeNghiThuongChiTieuBody extends StatefulWidget {
  DeNghiThuongChiTieuBody({Key? key}) : super(key: key);

  @override
  State<DeNghiThuongChiTieuBody> createState() =>
      _DeNghiThuongChiTieuBodyState();
}

class _DeNghiThuongChiTieuBodyState extends State<DeNghiThuongChiTieuBody>
    with AutomaticKeepAliveClientMixin<DeNghiThuongChiTieuBody> {
  @override
